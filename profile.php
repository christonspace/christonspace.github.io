<?php
$embedconn = mysqli_connect("localhost", "christon", "Jakari374", "christonspace");
?><head>
    <meta charset="utf-8">
...
if($_GET['id']) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<div class='userbanner'><h3><b>About Me: </b></h3></div>" . $row['description'] . "<br><br><b>Date Joined:</b> " . $row['date'] . "<br>"; 
        ...
        echo "<br><br><b><div class='music'>" . $row['username'] . "'s Favorite Music:</b><br><br><audio controls='' autoplay='' src='music/" . $row['musicurl'] . "'></audio><br><br></div><hr>";
    }
    $stmt->close();
}
?>
